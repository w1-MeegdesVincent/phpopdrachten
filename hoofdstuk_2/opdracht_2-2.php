...
<main id="wrapper">
    ...
    <p>
        <!--    tekst 1    -->
        <?php
            echo "$text1 $text4 $text5 $text3$text10 $text12 $text7 $text10 $text8$text9 $text12 $text6 $text5 $text3 $text13$text10";
        ?>
    </p>
    <p>
        <!--    tekst 2    -->
        <?php
        echo "$text1$text11 $text12 $text8 $text5 $text3$text10 $text12 $text7$text10 $text14$text9";
        ?>
    </p>
</main>
</body>
